...
import { MapPin, Tag, Save, UploadCloud, ArrowLeft, Trash2 } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between mb-4">
              ...
              {(newImages.length > 0 || images.length !== listingData.images.length) && (
                <button
                  ...
                  {previewUrls.map((url, index) => (
                    <div key={index} className="relative group aspect-square rounded-md overflow-hidden border border-gray-200">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-black/5 text-white opacity-0 group-hover:opacity-100 transition-opacity">
                        <span className="px-2 py-1 bg-indigo-600 text-xs font-medium rounded">New</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            {/* Upload Button */}
            <div>
              <label htmlFor="image-upload" className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 cursor-pointer transition-colors">
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="free-toggle" className="ml-2 block text-sm text-gray-700">
                      Free item
                    </label>
                  </div>
                </div>
