...
const mockListings = [
  {
    ...
    category: "buy",
    image:
      "https://images.unsplash.com/photo-1592078615290-033ee584dd43?ixlib=rb-4.0.3&auto=format&fit=crop&w=700&q=80",
  ...
  },
  {
    ...
    category: "free",
    image:
      "https://images.unsplash.com/photo-1463320898484-cdee8141c787?ixlib=rb-4.0.3&auto=format&fit=crop&w=700&q=80",
  ...
  },
  {
    ...
    category: "buy",
    image:
      "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?ixlib=rb-4.0.3&auto=format&fit=crop&w=700&q=80",
  ...
  return (
    <div className="min-h-screen bg-gray-50 border-1 border-gray-200 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-12">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8 animate-fade-up">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
            ...
            <div className="mt-4 md:mt-0">
              <Link
                to="/listings/new"
                className="bg-indigo-700 text-white py-2 px-3 font-semibold rounded-xl flex items-center hover:bg-indigo-800"
              >
        ...
        {/* Stats cards */}
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2 pb-10">
                  ...
                  {viewMode === "grid" ? (
                    ...
                    <div className="space-y-4">
                      {mockListings.map((listing) => (
                        <div
                          key={listing.id}
                          className="flex bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm transition-shadow hover:shadow-md"
                        >
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 animate-fade-up">
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    When you save listings you're interested in, they'll appear
                    here.
                  </p>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 animate-fade-up">
                ...
                <div className="space-y-6">
                  ...
                  {/* <div className="pt-6 border-t border-gray-200">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          ...
                          <p className="text-gray-500">
                            Receive email updates about your listings and
                            messages.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label
                            htmlFor="new_listings"
                            className="font-medium text-gray-700"
                          >
                            New Listings Alerts
                          </label>
                          <p className="text-gray-500">
                            Get notified when new items are listed in your area.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="pt-6 flex justify-end">
                    <button
                      type="button"
                      className="bg-indigo-800 py-2 px-3 rounded-xl text-white font-semibold"
                    >
                      Save Changes
                    </button>
                  </div>
